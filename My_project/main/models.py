...
class Employee(models.Model):
    name_emp = models.CharField(max_length=100,unique=True, blank=True)
    age_emp = models.IntegerField(blank=True,null=True,validators=[MaxValueValidator(150),MinValueValidator(0)])
    email_emp = models.CharField(max_length=256, validators=[EmailValidator],null=True,unique=True)
    password_emp = models.CharField(max_length=10,blank=False,null=False,default="123456")
    mob = models.CharField(max_length=12,blank=True, null=True, validators=[MaxLengthValidator(12), MinLengthValidator(10)])
    address = models.CharField(max_length=100, blank=True, null=False,)
